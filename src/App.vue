  ...
  <div id="app" class="app">
    ...
    <div class="main-component">
      <router-view
        ...
        v-on:completedLibrary="completedLibrary"
        v-on:logOut="logOut"
      >
      </router-view>
    </div>
...
export default {
  ...
  methods: {
    ...
    completedProductCreation: function(dataProduct) {
      alert("Producto creado exitosamente");
    },
    completedLibrary: function(){
